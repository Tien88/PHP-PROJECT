...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Admin Đã Xóa!';
   }else{
      $warning_msg[] = 'Admin Đã Xóa rồi!';
   }
...
<section class="grid">
   ...
   <div class="box" style="order: -1;">
      <p>Tên : <span><?= $fetch_admins['name']; ?></p>
      <a href="update.php" class="option-btn">Cập Nhật Tài Khoản</a>
      <a href="register.php" class="btn">Đăng Ký Mới</a>
   </div>
   <?php }else{?>
   <div class="box">
      <p>Tên : <span><?= $fetch_admins['name']; ?></p>
   ...
   ?>
      <p class="empty">Không Có Tài Khoản Admin</p>
